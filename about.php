        ...
        <div class="about-content">
            ...
            <div class="about-text-full">
                ...
                foreach ($paragraphs as $p): 
                    if (trim($p)):
                ?>
                    <p style="margin-bottom: 1.5rem; line-height: 1.8; font-size: 1.1rem;"><?= nl2br(htmlspecialchars(trim($p))) ?></p>
                <?php 
                    endif;
                endforeach; 
                ?>
                ...
                <div style="margin-top: 3rem; text-align: center;">
                    <a href="index.php#contact" class="btn btn-primary">Book an Appointment</a>
                </div>
            </div>
        </div>
    </div>
