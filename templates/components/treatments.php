    ...
    <div class="container">
        ...
        <div class="treatments-intro">
            ...
            <div class="intro-offer-block" style="margin-top: 2rem;">
                <p style="margin-bottom: 0.75rem; font-weight: 600; color: var(--pgw-primary); font-size: 1.1rem;"><?= htmlspecialchars($data['treatments']['intro_offer_text']) ?></p>
                <a href="<?= htmlspecialchars($PGW_MESSENGER_URL) ?>" class="btn btn-primary" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.5rem;">
                    <img src="assets/images/socials/messenger_icon_white.svg" alt="" width="20" height="20" style="width: 1.25rem; height: 1.25rem;">
        ...
        <div class="treatments-grid">
            ...
            <div class="treatment-card fade-in-section">
                ...
                <div class="treatment-img">
                    <img src="<?= htmlspecialchars($tImage) ?>" 
                         srcset="<?= get_srcset($tImage) ?>"
                ...
                <div class="treatment-info">
                    ...
                    <p class="duration"><?= htmlspecialchars($tDuration) ?> <?= $tPrice ? ' | ' . htmlspecialchars($tPrice) : '' ?></p>
