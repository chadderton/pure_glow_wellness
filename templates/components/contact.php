    ...
    <div class="container contact-container">
        <div class="contact-info">
            ...
            <div class="contact-details">
                <p>Phone / WhatsApp: <a href="tel:<?= htmlspecialchars(str_replace(' ', '', $data['contact']['phone'] ?? '')) ?>"><?= htmlspecialchars($data['contact']['phone'] ?? '') ?></a></p>
                <p>Email: <a href="mailto:<?= htmlspecialchars($data['contact']['email'] ?? '') ?>"><?= htmlspecialchars($data['contact']['email'] ?? '') ?></a></p>
                <p class="contact-prefer">
                    Prefer messaging? <a href="<?= htmlspecialchars($PGW_MESSENGER_URL) ?>" target="_blank" rel="noopener noreferrer">Message me on Facebook</a>.
                </p>
            </div>
        </div>
        ...
        <div class="contact-form-wrapper">
            ...
            <form id="contactForm" action="api/contact.php" method="POST" class="contact-form">
                ...
                <button type="submit" class="btn btn-primary"><?= htmlspecialchars($data['contact']['button_text'] ?? 'Send Message') ?></button>
            </form>
        </div>
    </div>
</section>
