...
<nav aria-label="breadcrumb" style="padding: 1rem 0; background-color: var(--pgw-cream); font-size: 0.9rem;">
    <div class="container">
        ...
        <span aria-current="page" style="color: var(--pgw-text);">Privacy Policy</span>
    </div>
</nav>
...
<div class="container" style="padding: 4rem 1rem; max-width: 800px;">
    ...
    <p>Pure Glow Wellness is a private facial and wellness studio based in Marple, Stockport. The data controller is
        Caroline Hines.</p>
    <p>Contact Email: <a href="mailto:pureglowfacials@gmail.com"
            style="color: var(--pgw-primary); font-weight: 600;">pureglowfacials@gmail.com</a></p>

    <h2 style="text-align: left; font-size: 1.5rem; margin-top: 2rem; margin-bottom: 1rem;">2. Information We Collect
    </h2>
    ...
    <h2 style="text-align: left; font-size: 1.5rem; margin-top: 2rem; margin-bottom: 1rem;">3. How We Use Your
        Information</h2>
    ...
    <h2 style="text-align: left; font-size: 1.5rem; margin-top: 2rem; margin-bottom: 1rem;">7. Changes to This Policy
    </h2>
    ...
    <p>If you have any questions about this privacy policy or how your data is handled, please contact me at <a
            href="mailto:pureglowfacials@gmail.com"
            style="color: var(--pgw-primary); font-weight: 600;">pureglowfacials@gmail.com</a>.</p>
</div>
